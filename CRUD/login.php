...
<head>
    ...
    <title>Login </title>
     <link rel="stylesheet" href="login_ style.css">
</head>
<body>
    <div class ="center">
        <h1>Login</h1>
        ...
        <div class="form">
            <input type="text" name=""class="textfiled"placeholder="username">
            <input type="password" name=""class="textfiled"placeholder="password">
